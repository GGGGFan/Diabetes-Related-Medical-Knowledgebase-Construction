...
sentTT = np.load('itmd_files/lstm_sentTT.npy')
pos1TT = np.load('itmd_files/lstm_pos1TT.npy')
pos2TT = np.load('itmd_files/lstm_pos2TT.npy')
relTT = np.load('itmd_files/lstm_relTT.npy')
...
for epoch in range(EPOCHS):
    ...
    try:
        ...
        continue
#Save model
torch.save(model, 'models/bilstm_att.pt')
